...
export class DelegatesController {
  ...
  @ApiResponse({ status: 200, description: 'Paginated list of delegates' })
  @Roles(Role.GM, Role.REGION_MANAGER)
  @Get()
  findAll(@Query() query: QueryDelegateDto, @Req() req: any) {
    return this.delegatesService.findAllForUser(query, req.user);
  }

  @ApiOperation({ summary: 'Create a delegate' })
  @ApiResponse({ status: 201, description: 'Delegate created' })
  @Roles(Role.GM)
  @Post()
  ...
  @ApiOperation({ summary: 'Get a delegate by ID' })
  @Roles(Role.GM, Role.REGION_MANAGER)
  @Get(':id')
  ...
  @ApiOperation({ summary: 'Delete a delegate' })
  @Roles(Role.GM)
  @Delete(':id')
